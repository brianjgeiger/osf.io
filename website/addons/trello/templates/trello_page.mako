...
<link rel="stylesheet" type="text/css" href="/addons/static/trello/trelloboard.css">
...
##                % if len(card[u'checklists']) != 0:
##                    <ul id="TrelloCheckList">
##                    % for checklist in card[u'checklists']:
##                        <li>${checklist[u'name']}</li>
##                        % if len(checklist[u'checkItems']) != 0:
##                            <ul id="TrelloCheckItem">
